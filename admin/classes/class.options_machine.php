	...
	public static function optionsframework_machine($options) {
		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
                ...
                // Languages menu
                case "menu":
                    $output .= '<a href="#'. $value['id'] .'">'. $value['std'] .'</a>';
                    break;

                case "menu_item":
                    $output .= '<a name="'. $value['id'] .'"></a>';
                    break;
				...
				case 'images':
					...
					$i++;
						...
						$output .= '<img src="'.$option.'" alt="" class="of-radio-img-img '. $selected .'" onClick="document.getElementById(\'of-radio-img-'. $value['id'] . $i.'\').checked = true;" alt="" />';
						$output .= '</span>';				
					}
