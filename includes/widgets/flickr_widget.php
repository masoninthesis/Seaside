...
class wpfw_flickr_widget extends WP_Widget
{
    function wpfw_flickr_Widget()
    {
        ...
        $widget_change = array('change1' => 'delay',
            ...
            'change4' => 100,
            'change5' => 0);
        $this->WP_Widget('wpfw_flickr_widget', 'GoGetThemes Flickr Widget ', $widget_style, $control_styles);
    }
    ...
    function widget($args, $cur_instance)
    {
        ...
        <script type="text/javascript"
                src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo $postcount ?>&amp;display=<?php echo $display ?>&amp;size=s&amp;layout=v&amp;source=<?php echo $type ?>&amp;<?php echo $type ?>=<?php echo $flickrID ?>"></script><?php
    ...
    function form($cur_instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __('Title','GoGetThemes'); ?>:</label>
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>"
                   name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $cur_instance['title']; ?>"/>
        </p>
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('class'); ?>"
                   name="<?php echo $this->get_field_name('class'); ?>" value="<?php echo $cur_instance['class']; ?>"/>
        </p>
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('flickrID'); ?>"
                   name="<?php echo $this->get_field_name('flickrID'); ?>"
                   value="<?php echo $cur_instance['flickrID']; ?>"/>
        </p>
        ...
        <p>
            ...
            <select id="<?php echo $this->get_field_id('postcount'); ?>"
                ...
                <option <?php if ('10' == $cur_instance['postcount']) echo 'selected="selected"'; ?>>10</option>
            </select>
        </p>
