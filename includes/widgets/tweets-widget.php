...
class Tweets_Widget extends WP_Widget {
                    ...
                    <div class="twitter-holder">
                        <div class="b">
                            <div class="tweets-container" id="tweets_<?php echo $args['widget_id']; ?>">
                                <ul id="jtwt">
                                    <?php $i = 0; foreach($twitter as $tweet): $i++;
                                        if($i == 1) { $class = "odd";} else { $class = "even";}
                                        ?>
                                        <li class="jtwt_tweet <?php echo $class;?>">
    ...
    {
        $defaults = array('title' => 'Recent Tweets', 'twitter_id' => 'gogetthemes', 'count' => 3, 'consumer_key' => 'c8Er9yoTIjIMEwZGGZx8Vg', 'consumer_secret' => '7i76UPFiu0RU3gaRMhTT9uQYxviBydk8jFFpjy0Mw', 'access_token' => '1346236734-MydnjScWcLlaNwCPG1ZpwJAHy5zDHkzrprfGKB0', 'access_token_secret' => 'qObuE8QAiNvzDteZoYXascVTNagwfuEIJ8qLszJ5A' );
